...
public final class DirectionalShadowMap {
    ...
    private static final float LIGHT_DISTANCE = 95f;
    private static final float Z_DEPTH_MULTIPLIER = 10f;

    private final int size;
    private final int cascadeCount;
    private final float cascadeLambda;
    ...
    public DirectionalShadowMap(int size, int cascadeCount, float cascadeLambda,
                                float fovDegrees, float nearPlane, float farPlane,
                                Vector3f initialSunDirection) {
        this.size = size;
        this.cascadeCount = cascadeCount;
        this.cascadeLambda = cascadeLambda;
    ...
    public void updateLightMatrices(
        ...
        for (int i = 0; i < cascadeCount; i++) {
            ...
            tmpEye.set(tmpLightDir).mul(-LIGHT_DISTANCE).add(sliceCenter);
            ...
            tmpLightProj.identity().ortho(
                tmpMin.x, tmpMax.x,
                tmpMin.y, tmpMax.y,
                tmpMin.z - Z_DEPTH_MULTIPLIER, tmpMax.z + Z_DEPTH_MULTIPLIER
            );
